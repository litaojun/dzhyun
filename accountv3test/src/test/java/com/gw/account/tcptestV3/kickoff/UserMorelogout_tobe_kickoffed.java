...
public class UserMorelogout_tobe_kickoffed  extends Thread{
...
//第四個鏈接請求
        ...
        try {
        	...
        	Thread.sleep(1000);
        	client_servlogin9001_1.myLogOut(v3host, v3port, uname, uMarket1, usrpos1, netid1, pid1, appid);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
        //第二個鏈接登錄
      ...
      //第三個鏈接登錄
              ...
              //第四個鏈接登錄
                ...
                try {
                	...
                	Thread.sleep(1000);
                	client_servlogin9001_4.myLogOut(v3host, v3port, uname, uMarket4, usrpos4, netid4, pid4, appid);
        		} catch (InterruptedException e) {
        			e.printStackTrace();
        		}
              //第五個鏈接登錄
                ...
                try {
                	...
                	Thread.sleep(1000);
                	client_servlogin9001_5.myLogOut(v3host, v3port, uname, uMarket5, usrpos5, netid5, pid5, appid);
        		} catch (InterruptedException e) {
        			e.printStackTrace();
        		}
                //第六個鏈接登錄
                ...
                try {
                	...
                	Thread.sleep(1000);
                	client_servlogin9001_6.myLogOut(v3host, v3port, uname, uMarket6, usrpos6, netid6, pid6, appid);
        		} catch (InterruptedException e) {
        			e.printStackTrace();
        		}
                //第七個鏈接登錄
                ...
                try {
                	...
                	Thread.sleep(1000);
                	client_servlogin9001_7.myLogOut(v3host, v3port, uname, uMarket7, usrpos7, netid7, pid7, appid);
        		} catch (InterruptedException e) {
        			e.printStackTrace();
        		}
                //第八個鏈接登錄
