...
public class TopicInvestTest extends GetTestJson{
	...
	{
		String urlstr = "http://" + MyConfigUtil.getConfig("ip") + ":" +MyConfigUtil.getConfig("port") + "/topicinvest?topicid=5100&token=1168f6c581b1438aa58648475dce93cd";
	...
	{
		String urlstr = "http://" + MyConfigUtil.getConfig("ip") + ":" +MyConfigUtil.getConfig("port") + "/topicinvest/history?topicid=52&token=1168f6c581b1438aa58648475dce93cd";
		String retstr = MyHttpUtil. getQuoteDyna(urlstr,"json");
		//System.out.println("retstr="+retstr+"\n");
		JSONObject data = JSON.parseObject(retstr);
	...
	{
		String urlstr = "http://" + MyConfigUtil.getConfig("ip") + ":" +MyConfigUtil.getConfig("port") + "/quote/kline?obj=SZ300298&period=1day&begin_time=20150703-000000&end_time=20150703-173502&token=1168f6c581b1438aa58648475dce93cd";
		String retstr = MyHttpUtil. getQuoteDyna(urlstr,"json");
		//System.out.println("retstr="+retstr+"\n");
		JSONObject data = JSON.parseObject(retstr);
	...
	{
		JSONArray JSONArray = (JSONArray)jsobj.getJSONObject("Data").get("RepDataQuoteDynaSingle");
		...
		//System.out.println(" x.getZhangFu()="+ topic.getZhangFu()+"xx=="+tstjs.getFloatValue("ZhangFu"));
		return topic;
	}
...
//			System.out.println("  x.getLiangBi()="+  x.getLiangBi());
		...
		System.out.println("huanshou总换手="+huanshou+"--topiclist.size()="+topiclist.size());
	...
	public static ArrayList<TopicInvestInfo> filterList(ArrayList<TopicInvestInfo> tllist)
	{
	...
	public static void main(String[] args)  {
		...
		for(String obj:alist)
		{
			...
			String urlstr = "http://10.15.144.80/quote/dyna?obj="+ obj+"&token=4bbd1d25db4c481b806af98ee988ee43";
