...
//        int port = config.getInt("port");
    ...
    public static void main(String[] args) {
        ...
        String dbName = "dzhST0";
        String collName = "ST37014";
        MongoCollection<Document> coll = MongoDBUtil.instance.getCollection(dbName, collName);
//        coll.aggregate({ $project : {title : 1 ,author : 1 ,}});
//        Filters.all(fieldName, values)
//        BasicDBObject  a = null;
        ...
        // 查询所有
//        Bson filter = Filters.eq("CV", 6236462680396267525L);
//        Filters.
//        MongoCursor<Document> a =  MongoDBUtil.instance.find(coll, filter);
//        
//        while(a.hasNext())
//        {
//        	Document b = a.next();
