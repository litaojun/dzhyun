...
public class IndicatorCalcTest extends GetTestJson
{
	...
	public void testIndicatorCalc() throws SAXException, Exception
	{
		...
		System.out.println(sentHttpReq);
	}
   
	@Parameters 
	public static Collection dateFeed() throws IOException
	{
		 TestCaseManagr a = new TestCaseManagr("E:\\环境文档\\测试用例.xlsx","指标计算接口",15);
		 //TestCaseManagr b = new TestCaseManagr("E:\\环境文档\\测试用例.xlsx","指标查询接口",17);
