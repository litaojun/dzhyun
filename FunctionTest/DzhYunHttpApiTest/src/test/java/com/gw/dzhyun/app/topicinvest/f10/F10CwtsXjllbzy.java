...
public class F10CwtsXjllbzy {
	...
	{
		String urlstr = "http://" + MyConfigUtil.getConfig("ip") + ":" +MyConfigUtil.getConfig("port") + "/f10/cwts/xjllbzy?obj=SH600745&token=44a92b0851fb47c8841602984efbfff7";
	...
	{
		String urlstr = "http://" + MyConfigUtil.getConfig("ip") + ":" +MyConfigUtil.getConfig("port") + "/f10/cwts/xjllbzy?obj=SH600745&field=czxjlr,jyxjlr,jyxjlc,tzxjje&start=-3&count=2&token=44a92b0851fb47c8841602984efbfff7&token=44a92b0851fb47c8841602984efbfff7";
		String retstr = MyHttpUtil. getQuoteDyna(urlstr,"json");
		//System.out.println("retstr="+retstr+"\n");
		JSONObject data = JSON.parseObject(retstr);
		TranYfloatMain tym = new TranYfloatMain(data,"RepDataF10CwtsXjllbzyOutput");
	...
	{
		String urlstr = "http://" + MyConfigUtil.getConfig("ip") + ":" +MyConfigUtil.getConfig("port") + "/f10/cwts/xjllbzy?obj=SH600745&field=jyxjlc,tzxjje&start=3&count=2&token=44a92b0851fb47c8841602984efbfff7";
		String retstr = MyHttpUtil. getQuoteDyna(urlstr,"json");
		//System.out.println("retstr="+retstr+"\n");
		JSONObject data = JSON.parseObject(retstr);
		TranYfloatMain tym = new TranYfloatMain(data,"RepDataF10CwtsXjllbzyOutput");
	...
	public static void main(String[] args) throws SAXException, Exception 
	{
        ...
        String[] urlstr = {"http://v2.yundzh.com/news?type=1&sort=DESC&start=0&count=5&obj=SH600128&token=c8b4fdf737494cd8934edcb7a51fc6ae",
